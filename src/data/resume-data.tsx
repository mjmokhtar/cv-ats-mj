...
export const RESUME_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "System validator to analyze and verify report outputs generated by the Advanced Driving Assistance System (ADAS) and the Driver Status Monitoring System (DSMS). The validator ensures the consistency, accuracy, and integrity of critical driving behavior and driver condition data, helping to identify anomalies, validate event triggers, and improve overall system reliability.",
      logo: MonitoLogo,
      link: {
        label: "github.com",
        href: "",
